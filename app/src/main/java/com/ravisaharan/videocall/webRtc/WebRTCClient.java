package com.ravisaharan.videocall.webRtc;
...
public class WebRTCClient {
    ...
    public WebRTCClient(Context context, PeerConnection.Observer observer,String username){
        ...
        iceServer.add(PeerConnection.IceServer.builder("turns:in.relay.metered.ca:443?transport=tcp")
                .setUsername("2fb224fb472ea992b489818f")
                .setPassword("M5EmNdwDzMCGrJb+").createIceServer());
    ...
    //Initializing ui like surface view render
    ...
    private void startLocalVideoStreaming(SurfaceViewRenderer view) {
        SurfaceTextureHelper helper=SurfaceTextureHelper
                .create(Thread.currentThread().getName(),eglBaseContext);
        ...
        localVideoTrack=peerConnectionFactory
                .createVideoTrack(localTrackId+"_video",localVideoSource);
        localVideoTrack.addSink(view);

        localAudioTrack=peerConnectionFactory
                .createAudioTrack(localTrackId+"_audio",localAudioSource);
